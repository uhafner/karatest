...
public class KaraWorld extends World {
    ...
    public static final GreenfootImage ICON_MY_KARA = new Assignment4().getImage();
	...
	private static WorldSetup loadWorldSetupFromFile(String worldFile) {
		...
		try {
			worldSetups = WorldSetup.parseFromFile(worldFile, Assignment4.class, WORLD_SETUP_TITLE_KEY, 
					KARA_DIRECTION_KEY);
